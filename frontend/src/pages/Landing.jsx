  ...
  return (
    <div className="w-full min-w-0 max-w-full overflow-hidden bg-white text-encre">
      ...
      <main>
        <section className="relative overflow-hidden bg-fond px-5 pb-20 pt-32 sm:px-8 lg:pb-28 lg:pt-40">
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-4 text-xs text-encre-sourde">4 000 min d'enregistrement incluses · Configuration guidée · Aucune carte bancaire requise</p>
        ...
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-10 gap-y-4 text-sm font-semibold text-encre-sourde"><TrustItem text="4 000 min d'essai gratuit" /><TrustItem text="Transcription automatique" /><TrustItem text="Analyse par NVIDIA NIM" /><TrustItem text="Comptes rendus structurés" /></div>
        </section>
        ...
        <section id="tarifs" className="scroll-mt-20 bg-white px-5 py-20 sm:px-8 lg:py-28">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-5 flex justify-center"><span className="rounded-full border border-liseret bg-fond px-3.5 py-2 text-xs font-medium text-encre-sourde">4 000 min d'essai gratuit incluses · Puis facturation mensuelle par entreprise · Paiement Mobile Money</span></div>
